/*********
  ...
  Complete project details at https://helloworld.co.in motor 4
*********/
...
void loop() {
  ...
  if (now - lastMsg > 4000) {
    ...
    client.publish("esp32/sensor4", "11"); //topic name (to which this ESP32 publishes its data). 88 is the dummy value.
