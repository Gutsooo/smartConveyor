...
#     print(twait)
    ...
    if len(classIds) != 0:
        ...
        for i in indices:
            ...
            if(classIds[i][0] == 44 and (current_time - last_run_time > 2)): #cellphone
            ...
            if(classIds[i][0] == 85 and (current_time - last_run_time > 2)): #clock
            ...
            if(classIds[i][0] == 52 and (current_time - last_run_time > 2)):  #banana
            ...
            if((classIds[i][0] == 49 or classIds[i][0] == 48)  and (current_time - last_run_time > 2)):  #banana
...
#                     print(e)
            ...
            if (current_time2 - last_run_time2 > 5) :

                flagstart = True

                                    

            if twait > 10 and flagstart:
